...
OUT=/data/wzl/LightningSearch-RL/results/phase5q-filtered-env-transition-grpo-4gpu-390x20-softanswer
CKPT=/data/wzl/LightningSearch-RL/checkpoints/phase5q-filtered-env-transition-grpo-4gpu-390x20-softanswer
