...
CONFIG=configs/experiments/phase5x_hard50_env_transition_grpo_4gpu_16x50_variance_rankreward_retry1.yaml
OUT=/data/wzl/LightningSearch-RL/results/phase5x-hard50-env-transition-grpo-4gpu-16x50-variance-rankreward-retry1
CKPT=/data/wzl/LightningSearch-RL/checkpoints/phase5x-hard50-env-transition-grpo-4gpu-16x50-variance-rankreward-retry1
LOG=/data/wzl/LightningSearch-RL/logs/phase5x-hard50-env-transition-grpo-4gpu-16x50-variance-rankreward-retry1.log
