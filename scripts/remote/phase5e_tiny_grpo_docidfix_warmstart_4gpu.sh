...
CONFIG=configs/experiments/phase5e_tiny_grpo_docidfix_warmstart_4gpu.yaml
OUT=/data/wzl/LightningSearch-RL/results/phase5e-tiny-grpo-docidfix-warmstart-4gpu
CKPT=/data/wzl/LightningSearch-RL/checkpoints/phase5e-tiny-grpo-docidfix-warmstart-4gpu
