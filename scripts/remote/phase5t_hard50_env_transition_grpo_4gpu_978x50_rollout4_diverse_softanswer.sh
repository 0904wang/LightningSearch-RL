...
CONFIG=configs/experiments/phase5t_hard50_env_transition_grpo_4gpu_978x50_rollout4_diverse_softanswer.yaml
OUT=/data/wzl/LightningSearch-RL/results/phase5t-hard50-env-transition-grpo-4gpu-978x50-rollout4-diverse-softanswer
CKPT=/data/wzl/LightningSearch-RL/checkpoints/phase5t-hard50-env-transition-grpo-4gpu-978x50-rollout4-diverse-softanswer
