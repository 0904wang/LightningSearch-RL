...
OUT=/data/wzl/LightningSearch-RL/results/phase5o-env-transition-grpo-4gpu-100x5-rewarddump
CKPT=/data/wzl/LightningSearch-RL/checkpoints/phase5o-env-transition-grpo-4gpu-100x5-rewarddump
