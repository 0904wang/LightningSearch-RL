...
OUT=/data/wzl/LightningSearch-RL/results/phase5x-hard50-env-transition-grpo-4gpu-16x15-variance-rankreward
CKPT=/data/wzl/LightningSearch-RL/checkpoints/phase5x-hard50-env-transition-grpo-4gpu-16x15-variance-rankreward
