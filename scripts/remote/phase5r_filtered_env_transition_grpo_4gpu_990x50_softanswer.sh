...
CONFIG=configs/experiments/phase5r_filtered_env_transition_grpo_4gpu_990x50_softanswer.yaml
OUT=/data/wzl/LightningSearch-RL/results/phase5r-filtered-env-transition-grpo-4gpu-990x50-softanswer
CKPT=/data/wzl/LightningSearch-RL/checkpoints/phase5r-filtered-env-transition-grpo-4gpu-990x50-softanswer
LOG=/data/wzl/LightningSearch-RL/logs/phase5r-filtered-env-transition-grpo-4gpu-990x50-softanswer.log
