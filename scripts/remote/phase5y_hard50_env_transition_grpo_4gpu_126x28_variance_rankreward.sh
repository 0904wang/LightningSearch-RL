...
CONFIG=configs/experiments/phase5y_hard50_env_transition_grpo_4gpu_126x28_variance_rankreward.yaml
OUT=/data/wzl/LightningSearch-RL/results/phase5y-hard50-env-transition-grpo-4gpu-126x28-variance-rankreward
CKPT=/data/wzl/LightningSearch-RL/checkpoints/phase5y-hard50-env-transition-grpo-4gpu-126x28-variance-rankreward
