...
CONFIG=configs/experiments/phase6d_gdpo_warmup_from_phase5y.yaml
OUT=/data/wzl/LightningSearch-RL/results/phase6d-gdpo-warmup-from-phase5y
CKPT=/data/wzl/LightningSearch-RL/checkpoints/phase6d-gdpo-warmup-from-phase5y
