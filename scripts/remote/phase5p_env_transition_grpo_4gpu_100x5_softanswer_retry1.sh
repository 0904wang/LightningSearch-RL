...
OUT=/data/wzl/LightningSearch-RL/results/phase5p-env-transition-grpo-4gpu-100x5-softanswer-retry1
CKPT=/data/wzl/LightningSearch-RL/checkpoints/phase5p-env-transition-grpo-4gpu-100x5-softanswer-retry1
