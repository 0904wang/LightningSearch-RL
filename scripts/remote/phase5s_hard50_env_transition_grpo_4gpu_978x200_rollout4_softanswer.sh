...
CONFIG=configs/experiments/phase5s_hard50_env_transition_grpo_4gpu_978x200_rollout4_softanswer.yaml
OUT=/data/wzl/LightningSearch-RL/results/phase5s-hard50-env-transition-grpo-4gpu-978x200-rollout4-softanswer
CKPT=/data/wzl/LightningSearch-RL/checkpoints/phase5s-hard50-env-transition-grpo-4gpu-978x200-rollout4-softanswer
