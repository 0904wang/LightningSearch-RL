...
GRPO_CKPT=$PHASE5Y_CKPT_ROOT/global_step_28/actor
GRPO_MERGED=$PHASE5Y_CKPT_ROOT/hf_merged_global_step_28
OUT=/data/wzl/LightningSearch-RL/results/phase5y-grpo-hard50-eval
SFT_OUT=$OUT/sft_baseline
GRPO_OUT=$OUT/grpo_global_step_28
LOG=/data/wzl/LightningSearch-RL/logs/phase5y-grpo-hard50-eval.log
GPU_IDS=${CUDA_VISIBLE_DEVICES:-4}
...
echo "phase5y_ckpt_root=$PHASE5Y_CKPT_ROOT"
...
run_eval "$GRPO_MERGED" "$GRPO_OUT" "grpo global_step_28"

PYTHONNOUSERSITE=1 python - <<'PY'
import json
from pathlib import Path

out = Path("/data/wzl/LightningSearch-RL/results/phase5y-grpo-hard50-eval")
sft_dir = out / "sft_baseline"
grpo_dir = out / "grpo_global_step_28"
