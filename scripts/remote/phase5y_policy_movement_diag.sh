...
GRPO_MODEL=/data/wzl/LightningSearch-RL/checkpoints/phase5y-hard50-env-transition-grpo-4gpu-126x28-variance-rankreward/hf_merged_global_step_28
OUT=/data/wzl/LightningSearch-RL/results/phase5y-policy-movement-diag
