...
OUT=/data/wzl/LightningSearch-RL/results/phase5u-hard50-env-transition-grpo-4gpu-978x200-rollout4-diverse-softanswer
CKPT=/data/wzl/LightningSearch-RL/checkpoints/phase5u-hard50-env-transition-grpo-4gpu-978x200-rollout4-diverse-softanswer
