...
OUT=/data/wzl/LightningSearch-RL/results/phase5q-env-transition-grpo-4gpu-400x20-softanswer
CKPT=/data/wzl/LightningSearch-RL/checkpoints/phase5q-env-transition-grpo-4gpu-400x20-softanswer
