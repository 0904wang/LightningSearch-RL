...
OUT=/data/wzl/LightningSearch-RL/results/phase5m-env-transition-grpo-4gpu
CKPT=/data/wzl/LightningSearch-RL/checkpoints/phase5m-env-transition-grpo-4gpu
LOG=/data/wzl/LightningSearch-RL/logs/phase5m-env-transition-grpo-4gpu.log
